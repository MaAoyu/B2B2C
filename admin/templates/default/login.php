...
<script type="text/javascript">
    $(function() {
        ...
        slide_links        : 'blank',    
        slides             : [    
                                 {image : 'http://localhost/admin/templates/default/images/login/1.jpg'},
                                 {image : 'http://localhost/admin/templates/default/images/login/2.jpg'},
                                 {image : 'http://localhost/admin/templates/default/images/login/3.jpg'},
				 {image : 'http://localhost/admin/templates/default/images/login/4.jpg'},
				 {image : 'http://localhost/admin/templates/default/images/login/5.jpg'}
                       ]
   ...
   if(top.location!=this.location)	top.location=this.location;
    $('#user_name').focus();
    if ($.browser.msie && ($.browser.version=="6.0" || $.browser.version=="7.0")){
        window.location.href='http://localhost/admin/templates/default/ie6update.html';
    }
    $("#captcha").nc_placeholder();
	//动画登录
    $('.input-button').click(function(e){
